...
const CreateBusinessPartnerForm = (props) => {
    ...
    const createBusinessPartnerSubmitHandler = async (el) => {
        el.preventDefault();
    ...
    return (<form
        onSubmit={createBusinessPartnerSubmitHandler}
        action=""
        className="flex gap-6 flex-col w-full"
    >
        <FormControl fullWidth>
            <InputLabel id="demo-simple-select-label">Selected Panel</InputLabel>
            <Select
