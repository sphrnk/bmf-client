...
import UpdateIndividualPanelInformation from "../Panels/Individual/UpdateIndividualPanelInformation";
...
const UpdateClientIndividualPanels = (props) => {
        ...
        <Box sx={{
            ...
            {props.panels.map((panel, i) =>
                <VerticalTabPanel key={i} value={individualPanelTab} index={i}>
                    <UpdateIndividualPanelInformation panel={panel}/>
                </VerticalTabPanel>
            )}
...
export default UpdateClientIndividualPanels